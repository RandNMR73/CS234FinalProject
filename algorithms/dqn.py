...
def train_dqn(env, args, output_path, new_logger):
    ...
    model = DQN(
        ...
        env=env,
        learning_rate=args.dqn-lr_rate,
        buffer_size=args.dqn-buffer_size,
        learning_starts=args.dqn-learning_starts,
        batch_size=args.dqn-batch_size,
        tau=args.dqn-tau,
        gamma=args.dqn-gamma,
        train_freq=args.dqn-train_freq,
        gradient_steps=args.dqn-gradient_steps,
        replay_buffer_class=None,
        replay_buffer_kwargs=None,
        optimize_memory_usage=args.dqn-optimize_memory-usage,
        target_update_interval=args.dqn-target-update-interval,
        exploration_fraction=args.dqn-exploration-fraction,
        exploration_initial_eps=args.dqn-exploration-initial-eps,
        exploration_final_eps=args.dqn-exploration-final-eps,
        max_grad_norm=args.dqn-max-grad-norm,
        stats_window_size=100,
        tensorboard_log=output_path,
        policy_kwargs=None,
        verbose=args.dqn-verbose,
        seed=args.dqn-agent-seed,
        device=args.dqn-device,

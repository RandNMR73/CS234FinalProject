# Code modified from GenRL repo https://github.com/SforAiDl/genrl.git 
import random
...
from algorithms.core.base import BaseActorCritic, BasePolicy, BaseValue
from algorithms.core.noise import NoisyLinear
...
def get_model(type_: str, name_: str): #-> Union:
    ...
    """
    if type_ == "ac":
        from algorithms.core.actor_critic import get_actor_critic_from_name

        return get_actor_critic_from_name(name_)
    elif type_ == "v":
        from algorithms.core.values import get_value_from_name

        return get_value_from_name(name_)
    elif type_ == "p":
        from algorithms.core.policies import get_policy_from_name
...
def get_env_properties(
    env: Union[gymnasium.Env], network: Union[str, Any] = "mlp"
) -> (Tuple[int]):
    """
...
def set_seeds(seed: int, env: Union[gymnasium.Env] = None) -> None:
    """
